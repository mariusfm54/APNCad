...
FORM_CLASS, _ = uic.loadUiType(
    os.path.join(str(Path(__file__).resolve().parent.parent), "forms", "liste_point_dialog.ui")
)


class ListePointDialog(QtWidgets.QDialog, FORM_CLASS):
    def __init__(self, parent=None):
        """Constructor."""
        super(ListePointDialog, self).__init__(parent)
