...
FORM_CLASS, _ = uic.loadUiType(
    os.path.join(str(Path(__file__).resolve().parent.parent), "forms", "clavier_complet_dialog.ui"))


class ClavierCompletDialog(QtWidgets.QDialog, FORM_CLASS):
    def __init__(self, parent=None):
        """Constructor."""
        super(ClavierCompletDialog, self).__init__(parent)
