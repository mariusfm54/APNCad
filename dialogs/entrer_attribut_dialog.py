...
FORM_CLASS, _ = uic.loadUiType(
    os.path.join(str(Path(__file__).resolve().parent.parent), "forms", "entrer_attribut_dialog.ui")
)


class EntrerAttributDialog(QtWidgets.QDialog, FORM_CLASS):
    def __init__(self, parent=None):
        """Constructor."""
        super(EntrerAttributDialog, self).__init__(parent)
