...
FORM_CLASS, _ = uic.loadUiType(
    os.path.join(str(Path(__file__).resolve().parent.parent), "forms", "build_layer_dialog.ui")
)


class BuildLayerDialog(QtWidgets.QDialog, FORM_CLASS):
    def __init__(self, parent=None):
        """Constructor."""
        super(BuildLayerDialog, self).__init__(parent)
